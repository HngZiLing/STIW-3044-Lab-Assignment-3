    ...
    <body>
        ...
        <div class="w3-card w3-container w3-padding w3-margin w3-round">
            ...
            <form action="index.php">
                <h5><input class="w3-half w3-input w3-block w3-round w3-border" type="search" id="idsearch" name="search" placeholder="Enter search term" />
        ...
        <div class="w3-grid-template">
            <?php
                foreach($rows as $subjects) {
                    ...
                    <a class='w3-button w3-hover-blue w3-center w3-border w3-normal' style='border-radius:20px;' href='subjectDetail.php?subject_id=$subjectId'>View All</a>
                    </div></div></div>";
                }
            ?>
        </div>
