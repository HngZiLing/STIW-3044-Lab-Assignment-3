<?php
    ...
    if(isset($_GET['subject_id'])) {
        ...
        $sqlsubject = "SELECT mytutordb.tbl_subjects.subject_id, mytutordb.tbl_subjects.subject_name, mytutordb.tbl_subjects.subject_description, mytutordb.tbl_subjects.subject_price, mytutordb.tbl_subjects.tutor_id, mytutordb.tbl_subjects.subject_sessions, mytutordb.tbl_subjects.subject_rating, mytutordb.tbl_tutors.tutor_id, mytutordb.tbl_tutors.tutor_name FROM mytutordb.tbl_subjects 
        INNER JOIN mytutordb.tbl_tutors ON mytutordb.tbl_subjects.tutor_id = mytutordb.tbl_tutors.tutor_id WHERE mytutordb.tbl_subjects.subject_id = '$subject_id'";
